 ...
 * Signature: ()V;
 */
JNIEXPORT void JNICALL Java_xyz_teamgravity_jnidemo_core_util_manager_TextManager_000241_print
        (JNIEnv *, jobject);
 ...
 * Signature: ()V;
 */
JNIEXPORT void JNICALL Java_xyz_teamgravity_jnidemo_core_util_manager_TextManager_000242_print
        (JNIEnv *, jobject);
